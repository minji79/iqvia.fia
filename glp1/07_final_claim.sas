...
data final_claim_disc; set final_claim_disc; by patient_id; if first.patient_id; run; /* 466787 individuals */


/*============================================================*
| 2. identify the final claim among individuals with discontinuation ==0 (N= 155417)
*============================================================*/
proc sql;
...
data final_claim_non_disc; set final_claim_non_disc; by patient_id; if first.patient_id; run; /* 155417 individuals */


/*============================================================*
| 3. pool both datasets (N= 622204) == secondary cohorts
*============================================================*/
