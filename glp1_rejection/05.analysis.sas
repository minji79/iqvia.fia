...
/* model 0 - perfectly fit with the rejection reason */
...
proc logistic data=df;
    class patient_gender(ref='M') age_cat (ref='4') region (ref='Midwest') dominant_payer_adj (ref='Commercial') diabetes_history (ref='1') year(ref='2025')
          molecule_name (ref='SEMAGLUTIDE') / param=glm order=internal;
    model non_ad_event(event='1') = age_cat patient_gender dominant_payer_adj diabetes_history cash coupon discount_card molecule_name year;
run;
