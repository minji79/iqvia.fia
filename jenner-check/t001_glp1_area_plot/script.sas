/************************************************************************************
   ...
   Adapted from glp1/11_area_plot.sas in this repo. The aggregation, the
   YYYYMM->SAS-date conversion, the retain-based cumulative bounds, and the
   stacked BAND plot are kept exactly as written; only the data source is the
   small bundled sample built in autoexec.sas.
************************************************************************************/
